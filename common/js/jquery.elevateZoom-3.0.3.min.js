...
(function (d, h, l, m) {
    var k = {
        ...
        startZoom: function () {
            ...
            isNaN(b.options.zoomWindowPosition) ? b.zoomWindow = d("<div style='z-index:999;" + b.zoomWindowStyle + "' class='zoomWindow'>&nbsp;</div>").appendTo("body").click(function () {
                b.$elem.trigger("click")
            }) : b.zoomWindow = d("<div style='z-index:999;" + b.zoomWindowStyle + "' class='zoomWindow'>&nbsp;</div>").appendTo(b.zoomContainer).click(function () {
                b.$elem.trigger("click")
            });
        ...
        swaptheimage: function (b, a) {
            ...
            $('.zoloading').remove();
            c.options.loadingIcon && (c.spinner = d("<div class='zoloading' style=\"background: url('" + c.options.loadingIcon +
                "') no-repeat center;height:" + c.nzHeight + "px;width:" + c.nzWidth + 'px;z-index: 2000;position: absolute; background-position: center center;"></div>'),
                //c.$elem.after(c.spinner)
                $('.zoomWindow').append(c.spinner)
            );
            c.options.onImageSwap(c.$elem);
            c.zoomWindow.css({"background-image": ""});
        ...
        doneCallback: function () {
            this.options.loadingIcon && this.spinner.remove();//this.spinner.hide();
            this.nzOffset = this.$elem.offset();
            this.nzWidth = this.$elem.width();
            this.nzHeight = this.$elem.height();
