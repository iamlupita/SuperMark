...
<div class="sub_menu"><?php echo $this->get_label('pending products to deliver');?></div>
<table style="width: 100%" class="data_table">
		...
		<td class="dt_head_td"  width="25%"><?php echo $this->get_label('client');?></td>
		<td class="dt_head_td"  width="30%" style="text-align: center;"><?php echo $this->get_label('quantity');?> [<?php echo $this->get_label('shipped');?> / <?php echo $this->get_label('total');?>]</td>
		
		
		
		<td width="5%" class="dt_head_td"><?php echo $this->get_label('action');?></td></tr>
 <?php 
...
?>
				<label class="shippeddiv"><?php echo $shquantity;?></label><label> / <?php echo $row['quantity'];?></label>
