...
$form->start("terms",$this->make_url("system/privacy"),"post");?>


<table style="width: 100%" cellpadding="0" cellspacing="0">

<tr><td colspan="4" class="heading_td"><b><?php echo $this->get_label('privacy policy');?></b></td></tr>
...
<tr><td colspan="4" height="10px"></td></tr>
  ...
  <tr>
    ...
    <td width="30px">&nbsp;</td>
    <td>
    <textarea name="description" id="description" rows="25" cols="80" class="textStylePadding"><?php echo $description; ?></textarea><span class="compulsory">*</span></td>
    <td>&nbsp;</td>
  </tr>
