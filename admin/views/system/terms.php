...
<div class="sub_menu"><?php echo $this->get_label('terms conditions');?></div>
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="30px">&nbsp;</td>
    <td>
    <textarea name="description" id="description" rows="50" cols="80" class="textStylePadding"><?php echo $description; ?></textarea><span class="mandatory">*</span></td>
    <td>&nbsp;</td>
  </tr>
