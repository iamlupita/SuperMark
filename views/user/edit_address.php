...
<div class="accountData contentLeft">
  ...
  <?php 
        $form=$this->create_form();
         $form->start("edit_new_address",$this->make_url("user/edit_address"),"post",$validate);
		 
 ?>              
 
 			<div style="width:74%;float:left;">
				<h1 class="titleh1"><?php echo $this->get_label('edit address');?></h1>
			</div>
             ...
             <div class="label_text_field">
           		  <input  name="name" id="name" type="text" value="<?php echo $this->get_variable("name");?>" class="textStyle2">
            </div>
           ...
           <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="address1" id="address1" type="text" value="<?php echo $this->get_variable("address1");?>" class="textStyle2">
            </div>
            ...
            <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="address2" id="address2" type="text" value="<?php echo $this->get_variable("address2");?>" class="textStyle2">
            </div>
            ...
            <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="phone" id="phone" type="text" value="<?php echo $this->get_variable("phoneno");?>" class="textStyle2">
            </div>
           		...
           		<select name="country" id="country" style="width: 338px;">
                    <option value="" selected="selected"><?php echo $this->get_label('select');?></option>
                       <?php $countries=$this->get_result('countries');
    					...
    					{
    					?>
                         <option value="<?php echo $row['ccode']; ?>" <?php if($this->get_variable("country")==$row['ccode']){ echo 'selected="selected"';}?> ><?php echo $row['cname']; ?></option>
                        <?php } ?> 
                </select> 
            </div>
            ...
            <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="state" id="state" type="text" value="<?php echo $this->get_variable("state");?>" class="textStyle2">
            </div>
             ...
             <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="city" id="city" type="text" value="<?php echo $this->get_variable("city");?>" class="textStyle2">
            </div>
             ...
             <div class="label_div">
              ...
              <div class="label_text_field">
           		<input name="zipcode" id="zipcode" type="text" value="<?php echo $this->get_variable("zipcode");?>" class="textStyle2">
            </div>
            
            </div>
            
            <div class="submit-btn-div">
            <input name="address_id" id="address_id" type="hidden" value="<?php echo $this->get_variable("id");?>">
